...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">EDICION </h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    {!!Form::model($descripcions,['route'=>['descripcion.update', $descripcions->id],'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
