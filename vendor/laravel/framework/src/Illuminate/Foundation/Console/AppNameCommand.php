...
class AppNameCommand extends Command
{
    ...
    /**
     * Set the authentication Usuario namespace.
     *
     * @return void
     */
    ...
    {
        $this->replaceIn(
            $this->getConfigPath('auth'), $this->currentRoot.'\\Usuario', $this->argument('name').'\\Usuario'
        );
    }

    /**
     * Set the services Usuario namespace.
     *
     * @return void
     */
    ...
    {
        $this->replaceIn(
            $this->getConfigPath('services'), $this->currentRoot.'\\Usuario', $this->argument('name').'\\Usuario'
        );
    }
